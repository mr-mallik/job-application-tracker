  ...
  return (
    <div className="prose prose-slate max-w-none">
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          This Cookie Policy explains how Job Application Tracker ("we", "our", or "us") uses cookies and similar 
          technologies when you use our service. This policy should be read together with our Privacy Policy and 
          Terms of Service.
        </p>
        <p className="mb-4">
          By using our Service, you consent to the use of cookies in accordance with this policy. If you do not 
          agree to our use of cookies, you should disable cookies through your browser settings or discontinue use 
          of the Service.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          ...
          a website. They are widely used to make websites work more efficiently and provide information to the site owners.
        </p>
        <p className="mb-4">
      ...
      <section className="mb-8">
        ...
        <h3 className="text-xl font-semibold mb-3 mt-6">3.1 Essential Cookies (Strictly Necessary)</h3>
        <p className="mb-4">
          These cookies are necessary for the Service to function and cannot be disabled in our systems.
        </p>
        ...
        <p className="mb-4">
          <strong>Legal Basis:</strong> These cookies are necessary for contract performance (GDPR Article 6(1)(b)) 
          and cannot be disabled without affecting Service functionality.
        </p>
        ...
        <p className="mb-4">
          <strong>Legal Basis:</strong> Consent (GDPR Article 6(1)(a)) or legitimate interests (GDPR Article 6(1)(f)).
        </p>
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc pl-6 mb-4 space-y-2">
          <li><strong>localStorage.token:</strong> JWT authentication token (expires after 7 days)</li>
          <li><strong>localStorage.user:</strong> User profile data for quick access</li>
          <li><strong>localStorage.preferences:</strong> UI preferences and settings</li>
        </ul>
        <p className="mb-4">
          Local Storage data persists until explicitly deleted by you or our application. This data is not 
          transmitted to our servers unless you initiate an action that requires it.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          When using AI features, Google may set cookies according to their privacy policy. We do not have 
          control over these cookies.
        </p>
        <ul className="list-disc pl-6 mb-4 space-y-2">
          <li>Purpose: AI model processing and service delivery</li>
          <li>Privacy Policy: <a href="https://policies.google.com/privacy" className="text-blue-600 hover:underline">https://policies.google.com/privacy</a></li>
        </ul>
        ...
        <p className="mb-4">
          Email verification and password reset emails may contain tracking pixels to measure delivery and open rates.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          Cookies are set for different durations based on their purpose:
        </p>
        <ul className="list-disc pl-6 mb-4 space-y-2">
          <li><strong>Session Cookies:</strong> Deleted when you close your browser</li>
          <li><strong>Authentication Cookies:</strong> 7 days (matches JWT token expiry)</li>
          <li><strong>Preference Cookies:</strong> 30 days to 1 year</li>
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          <strong className="text-red-600">Important:</strong> If you disable or delete essential cookies, 
          the Service will not function properly. Specifically:
        </p>
        <ul className="list-disc pl-6 mb-4 space-y-2">
        ...
        <p className="mb-4">
          Disabling non-essential cookies (analytics, marketing) will not affect core functionality but may 
        ...
        <p className="mb-4">
          Alternatively, log out from the Service to clear authentication data, or use the "Clear browsing data" 
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          Some browsers offer a "Do Not Track" (DNT) signal. Currently, there is no industry standard for 
          interpreting DNT signals. We do not respond to DNT signals, but we minimize data collection and 
          respect your privacy choices through browser settings.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          Under GDPR and ePrivacy Directive (Cookie Law):
        </p>
        <ul className="list-disc pl-6 mb-4 space-y-2">
          <li><strong>Strictly necessary cookies</strong> do not require consent (Article 6(1)(b) and Recital 49)</li>
          <li><strong>Non-essential cookies</strong> require informed consent before placement</li>
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          Uses JWT tokens stored in Local Storage (not cookies) with 7-day expiry. This is more secure than 
          traditional session cookies and allows for stateless authentication.
        </p>

        <h3 className="text-xl font-semibold mb-3 mt-6">10.2 Document Generation (AI Features)</h3>
        <p className="mb-4">
          AI processing is server-side and does not set additional cookies. Your profile data is temporarily 
          sent to Google Gemini AI and not stored by them (per their policy).
        </p>

        <h3 className="text-xl font-semibold mb-3 mt-6">10.3 Job Scraping</h3>
        <p className="mb-4">
          Web scraping is performed server-side using Playwright. No cookies are set on your device for this feature.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          Cookies may result in data transfer to servers located outside your country. We ensure appropriate 
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          Material changes will be notified via email or prominent notice. Your continued use after changes 
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          Last cookie audit performed: January 2026
        </p>
        <p className="mb-4">
          We regularly review and audit our cookie usage to ensure compliance and minimize data collection. 
      ...
      <div className="mt-12 p-6 bg-blue-50 border border-blue-200 rounded-lg">
        ...
        <p className="text-sm">
          Questions? Email us at <a href="mailto:cookies@jobtracker.app" className="text-blue-600 hover:underline">cookies@jobtracker.app</a>
        </p>
      </div>
    </div>
  )
