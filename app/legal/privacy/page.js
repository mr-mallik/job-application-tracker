  ...
  return (
    <div className="prose prose-slate max-w-none">
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          Job Application Tracker ("we", "our", or "us") is committed to protecting your privacy and personal data. 
          This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use 
          our job application tracking service.
        </p>
        <p className="mb-4">
          This policy complies with the General Data Protection Regulation (GDPR), UK Data Protection Act 2018, 
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          The data controller responsible for your personal data is Job Application Tracker. 
          For any questions about this policy or your data, please contact us at the details provided in Section 11.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc pl-6 mb-4 space-y-2">
          ...
          <li><strong>Profile Data:</strong> Professional designation, phone number, LinkedIn profile, portfolio URL, professional summary</li>
          <li><strong>Resume Information:</strong> Work experience, education, skills, projects, interests, achievements</li>
          <li><strong>Job Application Data:</strong> Job titles, company names, locations, salaries, application dates, job descriptions, requirements, custom notes</li>
          <li><strong>Documents:</strong> Resumes, cover letters, supporting statements that you create or upload</li>
        </ul>
        ...
        <ul className="list-disc pl-6 mb-4 space-y-2">
          <li><strong>Job Board Scraping:</strong> When you provide a job posting URL, we extract publicly available information</li>
          <li><strong>AI Processing:</strong> Your data may be processed by Google Gemini AI to generate or refine documents</li>
        </ul>
      </section>
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc pl-6 mb-4 space-y-2">
          ...
          <li><strong>Contract Performance:</strong> Processing necessary to provide you with our job tracking services</li>
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc pl-6 mb-4 space-y-2">
          <li><strong>MongoDB:</strong> Database hosting for storing your data</li>
          <li><strong>Google Gemini AI:</strong> AI model for document generation and job data classification</li>
          <li><strong>Email Service (SMTP):</strong> For sending verification and password reset emails</li>
        </ul>
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc pl-6 mb-4 space-y-2">
          ...
          <li><strong>Application Data:</strong> Retained as long as your account is active</li>
          <li><strong>Verification Codes:</strong> Deleted after 24 hours or upon successful verification</li>
          <li><strong>Password Reset Codes:</strong> Deleted after 1 hour or upon successful reset</li>
          <li><strong>Logs and Analytics:</strong> Retained for up to 90 days for security purposes</li>
        </ul>
        <p className="mb-4">
          After account deletion, we may retain certain data for legal compliance, dispute resolution, 
          and enforcing our agreements for up to 7 years.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          ...
          your data may be transferred across international borders. We ensure adequate protection through:
        </p>
        <ul className="list-disc pl-6 mb-4 space-y-2">
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          ...
          an updated "Last updated" date. Material changes will be notified via email or a prominent notice 
          in our service. Continued use after changes constitutes acceptance of the new policy.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          Our service uses Google Gemini AI for document generation and job data classification. When using these features:
        </p>
        <ul className="list-disc pl-6 mb-4 space-y-2">
          <li>Your profile data and job descriptions are sent to Google's AI service for processing</li>
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          When you provide a job posting URL, we use automated tools to extract publicly available information. 
          This feature:
        </p>
        <ul className="list-disc pl-6 mb-4 space-y-2">
      ...
      <div className="mt-12 p-6 bg-blue-50 border border-blue-200 rounded-lg">
        ...
        <p className="text-sm">
          ...
          please don't hesitate to contact us at <a href="mailto:privacy@jobtracker.app" className="text-blue-600 hover:underline">privacy@jobtracker.app</a>
        </p>
      </div>
    </div>
  )
