...
import { ExternalLink, FileText, Sparkles, RefreshCw, Briefcase, Bell, Loader2, Building2, MapPin, DollarSign, Calendar, FileCheck, Info } from 'lucide-react'
...
export function JobForm({ job, onSave, onCancel, token, userProfile }) {
  ...
  const handleScrape = async () => {
    if (!formData.url) { toast.error('Please enter a job URL first'); return }
    setScraping(true)
    try {
  ...
  const handleExtractFromText = async () => {
    if (!jobDescriptionText.trim()) { toast.error('Please paste a job description first'); return }
    setScraping(true)
    try {
        ...
        <CardContent className="p-6 space-y-4">
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-xs text-muted-foreground">Automatically extract job details using AI</p>
            </div>
          </div>
          ...
          {extractionMode === 'url' ? (
            <div className="space-y-3">
              <div className="space-y-2">
                ...
                <div className="flex gap-2">
                  ...
                  />
                  <Button type="button" onClick={handleScrape} disabled={scraping} className="shadow-sm">
                    {scraping ? (
            ...
            <div className="space-y-3">
              <div className="space-y-2">
                <Label htmlFor="job-text" className="text-sm font-medium">Paste Job Description</Label>
                <Textarea 
                  id="job-text"
...
• Application deadline"
                ...
                >
                  {scraping ? (
                    ...
                    <><Sparkles className="w-4 h-4 mr-2" />Extract Job Details with AI</>
                  )}
                </Button>
              </div>
              <Separator />
              <div className="space-y-2">
                <Label htmlFor="optional-url" className="text-xs text-muted-foreground">Job URL (Optional)</Label>
                <Input 
                  id="optional-url"
                  placeholder="https://..." 
                  value={formData.url} 
            ...
            <div className="flex-1 space-y-3">
              <div className="space-y-1">
                <div className="flex items-center gap-2">
                  ...
                  <Label htmlFor="reminder-enabled" className="cursor-pointer font-semibold text-base">
                    Email Reminder
                  </Label>
                </div>
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          <Label htmlFor="requirements" className="text-sm font-medium">Requirements & Qualifications</Label>
          <Textarea 
            id="requirements"
        ...
        <div className="space-y-2">
          <Label htmlFor="benefits" className="text-sm font-medium">Benefits & Perks (Optional)</Label>
          <Textarea 
            id="benefits"
        ...
        <div className="space-y-2">
          <Label htmlFor="notes" className="text-sm font-medium">Personal Notes (Optional)</Label>
          <Textarea 
            id="notes"
            className="min-h-[60px] resize-y font-sans" 
