...
import { 
  ...
  Upload, Mail, Phone, Link2, Trophy, Heart
} from 'lucide-react'
...
export function ProfileEditor({ user, token, onSave, onCancel }) {
  ...
  return (
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div className="flex-1">
                ...
                <p className="text-xs text-muted-foreground mt-1">Upload your PDF resume to auto-populate all fields using AI</p>
              </div>
        ...
        <div className="flex flex-col lg:flex-row gap-6">
              ...
              <div className="space-y-3">
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    ...
                    <Input id="name" placeholder="John Doe" className="pl-10" value={profileData.name} onChange={(e) => setProfileData({...profileData, name: e.target.value})} />
                  </div>
                </div>
                
                <div className="space-y-1.5">
                  <Label htmlFor="designation" className="text-xs font-medium">Designation/Title</Label>
                  <div className="relative">
                    <Briefcase className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-muted-foreground" />
                    <Input id="designation" placeholder="Senior Software Engineer" className="pl-10" value={profileData.designation} onChange={(e) => setProfileData({...profileData, designation: e.target.value})} />
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="space-y-1.5">
                    ...
                    <div className="relative">
                      ...
                      <Input id="phone" placeholder="+1 234 567 8900" className="pl-10" value={profileData.phone} onChange={(e) => setProfileData({...profileData, phone: e.target.value})} />
                    </div>
                  </div>
                  <div className="space-y-1.5">
                    ...
                    <div className="relative">
                      ...
                      <Input id="email" value={profileData.email} className="pl-10 bg-muted" disabled />
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    ...
                    <Input id="linkedin" placeholder="https://linkedin.com/in/username" className="pl-10" value={profileData.linkedin} onChange={(e) => setProfileData({...profileData, linkedin: e.target.value})} />
                  </div>
                </div>
                
                <div className="space-y-1.5">
                  <Label htmlFor="portfolio" className="text-xs font-medium">Portfolio Website</Label>
                  <div className="relative">
                    <Link2 className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-muted-foreground" />
                    <Input id="portfolio" placeholder="https://yourportfolio.com" className="pl-10" value={profileData.portfolio} onChange={(e) => setProfileData({...profileData, portfolio: e.target.value})} />
                  </div>
                </div>
            ...
            <div className="flex justify-between items-center">
              ...
              <div className="flex gap-2">
                {profileData.experiences.length > 1 && (
                  <Button size="sm" variant="outline" onClick={sortExperiencesChronologically} className="shadow-sm">
            ...
            <div className="space-y-3">
              ...
              {profileData.experiences.length === 0 && (
                <div className="text-center py-12 border-2 border-dashed rounded-lg">
                  ...
                  <p className="text-xs text-muted-foreground mb-3">Add your work history to generate better resumes</p>
          ...
          <TabsContent value="education" className="space-y-4">
            <div>
              ...
              <div className="space-y-3">
                <div className="space-y-1.5">
                  <Label htmlFor="degree" className="text-xs font-medium">Degree Name</Label>
                  <Input id="degree" placeholder="Bachelor of Science in Computer Science" value={profileData.education.degree} onChange={(e) => setProfileData({...profileData, education: {...profileData.education, degree: e.target.value}})} />
                </div>
                
                <div className="space-y-1.5">
                  <Label htmlFor="institution" className="text-xs font-medium">Institution</Label>
                  <Input id="institution" placeholder="University Name" value={profileData.education.institution} onChange={(e) => setProfileData({...profileData, education: {...profileData.education, institution: e.target.value}})} />
                </div>
                
                <div className="grid grid-cols-2 gap-3">
                  <div className="space-y-1.5">
                    <Label htmlFor="location" className="text-xs font-medium">Location</Label>
                    <Input id="location" placeholder="City, Country" value={profileData.education.location} onChange={(e) => setProfileData({...profileData, education: {...profileData.education, location: e.target.value}})} />
                  </div>
                  <div className="space-y-1.5">
                    <Label htmlFor="grade" className="text-xs font-medium">Grade/GPA</Label>
                    <Input id="grade" placeholder="3.8/4.0" value={profileData.education.grade} onChange={(e) => setProfileData({...profileData, education: {...profileData.education, grade: e.target.value}})} />
                  </div>
                </div>
                
                <div className="grid grid-cols-2 gap-3">
                  <div className="space-y-1.5">
                    <Label htmlFor="eduStart" className="text-xs font-medium">Start Date</Label>
                    <Input id="eduStart" placeholder="mm/yyyy" value={profileData.education.startDate} onChange={(e) => setProfileData({...profileData, education: {...profileData.education, startDate: e.target.value}})} />
                  </div>
                  <div className="space-y-1.5">
                    <Label htmlFor="eduEnd" className="text-xs font-medium">End Date</Label>
                    <Input id="eduEnd" placeholder="mm/yyyy" value={profileData.education.endDate} onChange={(e) => setProfileData({...profileData, education: {...profileData.education, endDate: e.target.value}})} />
                  </div>
                </div>
              </div>
            </div>
          ...
          <TabsContent value="skills" className="space-y-4">
            <div>
              ...
              <div className="space-y-3">
                <div className="space-y-1.5">
                  <Label htmlFor="relevantSkills" className="text-xs font-medium">Primary Skills (comma separated)</Label>
                  <Textarea 
                    id="relevantSkills"
                    placeholder="Python, JavaScript, React, Node.js, MongoDB, AWS..."
                    className="min-h-[100px] resize-y"
                    value={profileData.skills.relevant} 
                    onChange={(e) => setProfileData({...profileData, skills: {...profileData.skills, relevant: e.target.value}})} 
                  />
                </div>
                
                <div className="space-y-1.5">
                  <Label htmlFor="otherSkills" className="text-xs font-medium">Secondary/Soft Skills</Label>
                  <Textarea 
                    id="otherSkills"
                    placeholder="Leadership, Communication, Project Management, Agile..."
                    className="min-h-[100px] resize-y"
                    value={profileData.skills.other} 
                    onChange={(e) => setProfileData({...profileData, skills: {...profileData.skills, other: e.target.value}})} 
                  />
                </div>
              </div>
            </div>
                    ...
                    <CardContent className="pt-4 space-y-2">
                      <div className="flex gap-2">
                        ...
                        <Button 
                          variant="ghost" 
                          size="sm" 
                          onClick={() => setProfileData({...profileData, interests: profileData.interests.filter((_, idx) => idx !== i)})}
            ...
            <div className="space-y-3">
              ...
              {profileData.projects.length === 0 && (
                <div className="text-center py-12 border-2 border-dashed rounded-lg">
                  ...
                  <p className="text-xs text-muted-foreground mb-3">Showcase your personal or professional work</p>
      ...
      <div className="w-full lg:w-1/2">
        <div className="lg:sticky lg:top-6">
          <div className="mb-4">
            ...
            <p className="text-xs text-muted-foreground mt-1">Preview how your data will appear in generated resumes</p>
          </div>
    ...
    <div className="flex justify-between items-center pt-4">
      <p className="text-xs text-muted-foreground hidden sm:block">Changes are saved to your profile and used for all AI-generated documents</p>
