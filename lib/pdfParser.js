...
/**
 * Convert a user profile directly to a resume blocks[] array.
 * Convenience wrapper: profile → markdown → blocks.
 * @param {Object} profile - User profile object
 * @returns {Array} blocks[]
 */
export function profileToBlocks(profile) {
  return markdownToBlocks(profileToResumeMarkdown(profile), DOCUMENT_TYPES.RESUME);
}
